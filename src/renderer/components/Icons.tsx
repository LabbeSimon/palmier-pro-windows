...
export const IconNew = svg(
  <path d="M9.2 1.6H4.4a1.6 1.6 0 0 0-1.6 1.6v9.6a1.6 1.6 0 0 0 1.6 1.6h7.2a1.6 1.6 0 0 0 1.6-1.6V5.6Zm0 1.5 3 3h-2.2a.8.8 0 0 1-.8-.8Z" />,
)

export const IconOpen = svg(
  <path d="M2 4.2a1.4 1.4 0 0 1 1.4-1.4h2.5l1.3 1.6h4.4a1.4 1.4 0 0 1 1.4 1.4v.4H2Zm0 3.2h13v4.8a1.4 1.4 0 0 1-1.4 1.4H3.4A1.4 1.4 0 0 1 2 12.2Z" />,
)

export const IconSave = svg(
  <path d="M3 2.4h8.2L14 5.2v8.4a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.4a1 1 0 0 1 1-1Zm1.8 1.4v3h6.4v-3Zm.8 5.4h4.8v3.8H5.6Z" />,
)

export const IconRender = svg(
  <>
    <path d="M2 3.6a1.2 1.2 0 0 1 1.2-1.2h6.4a1.2 1.2 0 0 1 1.2 1.2v8.8a1.2 1.2 0 0 1-1.2 1.2H3.2A1.2 1.2 0 0 1 2 12.4Z" opacity=".55" />
    <path d="M12.2 5.4v5.2a.6.6 0 0 0 .92.5l2-2.6a.6.6 0 0 0 0-.75l-2-1.85a.6.6 0 0 0-.92.5Z" />
  </>,
)

export const IconMarkerAdd = svg(
  <path d="M3.6 1.6a.8.8 0 0 0-.8.8v11.2a.8.8 0 0 0 1.6 0V9.4h4.2a.8.8 0 0 0 .62-1.3L7.7 5.5l1.52-2.6a.8.8 0 0 0-.62-1.3Zm8.6 6.6V6.6a.7.7 0 1 1 1.4 0v1.6h1.6a.7.7 0 1 1 0 1.4h-1.6v1.6a.7.7 0 1 1-1.4 0V9.6h-1.6a.7.7 0 1 1 0-1.4Z" />,
)
